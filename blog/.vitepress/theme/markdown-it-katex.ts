...
import MarkdownIt, { Token, StateInline, StateBlock } from "markdown-it";
...
export default function mathPlugin(md: MarkdownIt, options?: KatexOptions) {
    ...
    var katexInline = function (latex: string): string {
    ...
    var inlineRenderer = function (tokens: Array<Token>, idx: number): string {
        return katexInline(tokens[idx].content);
    };

    var katexBlock = function (latex: string): string {
    ...
    var blockRenderer = function (tokens: Array<Token>, idx: number): string {
